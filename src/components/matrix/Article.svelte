...
> -->
			...
			<section
				id="section-1"
				class="prose prose-xl [&>*]:px-10 [&>*]:rounded-xl"
			>
				...
				<P id="st-1">
					Let's first think about what the coordinates of a <ColorText
						color="in">vector</ColorText
					> represent.
				</P>
				...
				<P id="st-2">
					In the <Tex expr={"xy"} />-coordinate plane, any vector can be thought
					of as the sum of two scaled vectors: the unit vector in the <ColorText
    ...
    /> -->
				...
				<p>
					Every vector can be expressed as a linear combination of basis
					vectors.
				</p>
				...
				<p>
					...
					multiplication? A vector multiplied with a matrix can also be
					expressed as a linear combination; this time with the columns of the
					matrix.
				</p>

				<p>
					In other words, a matrix can be viewed as a way of packaging
					information about our new basis vectors. This is the core insight: a
					matrix transforms a vector by transforming the original basis vectors;
					creating an entirely new coordinate system.
				</p>

				<p>
					In that vein, a matrix transformation appears to warp and transform
					space itself. In order to get a more visceral feel of this, let's
					visualize what happens to sample of points in space, each multiplied
					by the same matrix.
				</p>
				...
				<p>
					A visual example is that all grid lines stay parallel and evenly
					spaced.
				</p>
				...
				<p>
					With this understanding, try to tinker about and figure out what kinds
					of transformations are possible with matrices! What basis vectors
					should you choose in order to scale space? How about a reflection,
					rotation or a shear?
				</p>
			</section>
		</div>
